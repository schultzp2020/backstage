...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://github.com/backstage/backstage/blob/master/packages/cli-module-oxlint/docs/rules/no-ui-css-imports-in-non-frontend.md',
    },
  },
  createOnce(context) {
    let currentPackage;
    ...
    return {
      before() {
        ...
        currentPackage = packages?.byPath(resolveFilePath(context));
        if (!currentPackage) {
          return false;
        }
      },
